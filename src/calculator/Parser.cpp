...
namespace calculator {
    ...
    Ast::ExpressionPtr Parser::ParseFactor() {
        ...
        if (token.type == TokenType::Exponent) {
            Consume();
            auto exponent = std::make_unique<Ast::BinaryOperation>(Ast::BinaryOperation::BinaryOpType::Exponent);
    ...
    Ast::ExpressionPtr Parser::ParseExponent() {
        ...
        switch (token.type) {
            ...
            case TokenType::Substract:
                Consume();
                exponent = std::make_unique<Ast::UnaryOperation>(Ast::UnaryOperation::UnaryOpType::Negate, ParseExponent());
                break;
            default:
